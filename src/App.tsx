        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <p className="hero-support-subtitle">
              Also support reading PDF417, Aztec, Data Matrix, Micro QR, DataBar
              & other barcodes. Support decoding boarding passes.
            </p>
        ...
        {scanResult ? (
          <div className="result-card">
            ...
            {bcbpData && (
              ...
              >
                <p className="bcbp-label">IATA BCBP decoded:</p>
