...
function Logo() {
  return (
    <a className="brand" href="#top" aria-label="QR Studio Local home">
    ...
    <div className="site-shell" id="top">
      <header className="site-header">
        ...
        <button
          ...
          aria-label={
            theme === "dark"
              ? "Light is off. Turn light on"
              : "Light is on. Turn light off"
          }
        ...
        >
          ...
          {theme === "dark" ? "LIGHT IS OFF" : "LIGHT IS ON"}
        </button>
      </header>
          ...
          <div className="hero-copy">
            ...
            <h1 id="hero-title">
              ...
              <span className="hero-title-line">
                minus the <span className="hero-title-accent">fuss.</span>
              </span>
            </h1>
            ...
            <p className="hero-support-subtitle">
              ...
              DL/IDs.{" "}
              <span className="hero-web-app-ready">Web app ready.</span>
            </p>
      ...
      <footer>
        ...
        <div className="footer-publisher">
          <p className="footer-brand-title">QR Studio Local</p>
          <p className="footer-published">© 2026 Songming.org</p>
        </div>
      ...
      <div className="control-pane">
        ...
        <div className="field">
          <label htmlFor="barcode-content">
            <span className="field-label-title">{config.inputLabel}</span>
            <span className="field-label-counter">
        ...
        <div className="pane-heading">
          ...
          <div>
            ...
            <small className="reader-format-note">
              Supports: QR, PDF417, Aztec, UPC/EAN, Code 39/93/128, Data Matrix,
              ITF, DataBar, Codabar, and Micro QR.
            </small>
          </div>
        </div>
