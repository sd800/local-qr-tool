...
import { parseBcbp, type BcbpSegment } from "./bcbp";
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <p className="hero-subtitle">
              Create sharp, custom QR and other barcodes, or scan one in seconds.
        ...
        >
          <div className="option-grid">
            ...
            <label className="select-field">
              ...
              <select
                value={level}
                disabled={!config.supportsErrorRecovery}
                onChange={(event) =>
                ...
                title={
                  config.supportsErrorRecovery
                    ? undefined
                    : "Error recovery is set automatically for this format."
                }
              >
              ...
              >
                ...
                <dl className="bcbp-fields bcbp-summary">
                  ...
                  <BcbpField
                    ...
                    value={
                      bcbpData.electronicTicketIndicator === "E"
                        ? "Yes"
                        : bcbpData.electronicTicketIndicator || "Not indicated"
                    }
                  />
                  <BcbpField
                    label="Format"
                    value={bcbpData.formatCode}
                  />
                </dl>
  ...
  return (
    <section className="bcbp-flight">
      ...
      <dl className="bcbp-fields">
        ...
        <BcbpField
          label="Flight date"
          value={`Julian day ${segment.flightDate}`}
        />
        <BcbpField label="Compartment" value={segment.compartmentCode} />
