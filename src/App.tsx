            ...
            {bcbpData && (
              ...
              >
                ...
                <dl className="bcbp-fields bcbp-summary">
                  ...
                  <BcbpField
                    label="Format"
                    value={formatBcbpFormatCode(bcbpData.formatCode)}
                  />
                </dl>
  ...
  return (
    <div className="bcbp-field bcbp-field-wide bcbp-date-field">
      ...
      <dd className="bcbp-date-value">
        ...
        <span className="bcbp-date-calendar">{details.currentYearDate}</span>
        <span className="bcbp-date-label">{details.alternateYearLabel}</span>
        <span className="bcbp-date-calendar">{details.alternateYearDate}</span>
      </dd>
    </div>
  );
}
